...
//print("sqrt(+2/1, precision:128)==",   Rational.sqrt(+BigInt(2).over(1), precision:128))
//print("sqrt(+2/1, precision:256)==",   Rational.sqrt(+BigInt(2).over(1), precision:512))
print("sqrt(+1/2)==",   Rational.sqrt(+BigInt(1).over(2), precision:64))
print("exp(+0/1)==",   Rational.exp(+BigInt(0).over(1), precision:64))
print("exp(+1/1)==",   Rational.exp(+BigInt(1).over(1), precision:64))
print("exp(-1/1)==",   Rational.exp(-BigInt(1).over(1), precision:64))
print("exp(+2/1)==",   Rational.exp(+BigInt(2).over(1), precision:64))
print("exp(+1/2)==",   Rational.exp(+BigInt(1).over(2), precision:64))
print("log(+2/1)==",    Rational.log(+BigInt(2).over(1), precision:64))
// print("log(sqrt(+2/1))==",    Rational.log(Rational.sqrt(+BigInt(2).over(1), precision:128), precision:64))
