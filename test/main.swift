...
//
//print(Rational.sqrt(-BigInt(1).over(1), precision:64).isNaN)
//print(Rational.sqrt(+BigInt(1).over(1), precision:64))
//print(Rational.sqrt(+BigInt(2).over(1), precision:64))
//print(Rational.sqrt(+BigInt(1).over(2), precision:64))
//print(Rational.exp(+BigInt(0).over(1), precision:64))
//print(Rational.exp(+BigInt(1).over(1), precision:64))
//print(Rational.exp(-BigInt(1).over(1), precision:64))
//print(Rational.exp(+BigInt(1).over(2), precision:64))
//print(Rational.exp(+BigInt(2).over(1), precision:64))
//print(Rational.exp(+BigInt(1).over(2), precision:64))
//print(Rational.log(+BigInt(2).over(1), precision:64))
//print(Rational.log(+BigInt(10).over(1), precision:64))
//print(Rational.log(BigInt(8).over(1), precision:64))
//print(Rational.log(BigInt(2).over(1)))
//print(Rational.log(Rational.sqrt(BigInt(2).over(1), precision:64), precision:64))
