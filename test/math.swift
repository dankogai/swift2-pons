...
func testMath(test:TAP, num:Int=1, den:Int=4) {
    for i in 0...(num*den) {
        for s in [-1.0, 1.0] {
            ...
            test.eq(approx(r, BigFloat.sqrt,    Double.sqrt), true,     "BigFloat.sqrt(\(r))")
            test.eq(approx(q, BigRat.log,       Double.log), true,      "BigRat.log(\(q))")
            test.eq(approx(r, BigFloat.log,     Double.log), true,      "BigFloat.log(\(r))")
            test.eq(approx(q, BigRat.exp,       Double.exp), true,      "BigRat.exp(\(q))")
            test.eq(approx(r, BigFloat.exp,     Double.exp), true,      "BigFloat.exp(\(r))")
            test.eq(approx(q, BigRat.cos,       Double.cos), true,      "BigRat.cos(\(q))")
            test.eq(approx(r, BigFloat.cos,     Double.cos), true,      "BigFloat.cos(\(r))")
            test.eq(approx(q, BigRat.sin,       Double.sin), true,      "BigRat.sin(\(q))")
            test.eq(approx(r, BigFloat.sin,     Double.sin), true,      "BigFloat.sin(\(r))")
            test.eq(approx(q, BigRat.tan,       Double.tan), true,      "BigRat.tan(\(q))")
            test.eq(approx(r, BigFloat.tan,     Double.tan), true,      "BigFloat.tan(\(r))")
            test.eq(approx(q, BigRat.acos,      Double.acos), true,     "BigRat.acos(\(q))")
            test.eq(approx(r, BigFloat.acos,    Double.acos), true,     "BigFloat.acos(\(r))")
            test.eq(approx(q, BigRat.asin,      Double.asin), true,     "BigRat.asin(\(q))")
            test.eq(approx(r, BigFloat.asin,    Double.asin), true,     "BigFloat.asin(\(r))")
            test.eq(approx(q, BigRat.atan,      Double.atan), true,     "BigRat.atan(\(q))")
            test.eq(approx(r, BigFloat.atan,    Double.atan), true,     "BigFloat.atan(\(r))")
            test.eq(approx(q, BigRat.cosh,      Double.cosh), true,     "BigRat.cosh(\(q))")
            test.eq(approx(r, BigFloat.cosh,    Double.cosh), true,     "BigFloat.cosh(\(r))")
            test.eq(approx(q, BigRat.sinh,      Double.sinh), true,     "BigRat.sinh(\(q))")
            test.eq(approx(r, BigFloat.sinh,    Double.sinh), true,     "BigFloat.sinh(\(r))")
            test.eq(approx(q, BigRat.tanh,      Double.tanh), true,     "BigRat.tanh(\(q))")
            test.eq(approx(r, BigFloat.tanh,    Double.tanh), true,     "BigFloat.tanh(\(r))")
            test.eq(approx(q, BigRat.acosh,     Double.acosh), true,    "BigRat.acosh(\(q))")
            test.eq(approx(r, BigFloat.acosh,   Double.acosh), true,    "BigFloat.acosh(\(r))")
            test.eq(approx(q, BigRat.asinh,     Double.asinh), true,    "BigRat.asinh(\(q))")
            test.eq(approx(r, BigFloat.asinh,   Double.asinh), true,    "BigFloat.asinh(\(r))")
            test.eq(approx(q, BigRat.atanh,     Double.atanh), true,    "BigRat.atanh(\(q))")
            test.eq(approx(r, BigFloat.atanh,   Double.atanh), true,    "BigFloat.atanh(\(r))")
        }
    }
