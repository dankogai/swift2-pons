...
UIntMax.max
BigInt(UIntMax.max).nextPrime
BigInt(UIntMax.max).prevPrime


//BigUInt("3317044064679887385962123").isLucasProbablePrime
//BigUInt("4547337172376300111955330758342147474062293202868155909489").isSurelyPrime
//BigInt("3317044064679887385962123").isPrime
